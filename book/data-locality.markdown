...
what it's doing:
 ...
 1. The array of game entities is made of *pointers* to them, so for each element in the
...
actual concrete design space is wide open. You can let the <span name="dod">Data
Locality</span> pattern affect your whole architecture, or maybe it's just a localized
