...
The constructor is protected and takes the starting health for the
...
Another more powerful solution is to actually support defining
...
and <a class="pattern" href="virtual-machine">Virtual Machine</a>
